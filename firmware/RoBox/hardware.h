...
void hw_init();                         // initializes all the hardware
...
void hw_servoShoot();                   // shoots the ball by positioning the servo
void hw_servoLoad();                    // loads the ball by positioning the servo
void hw_servoStart();                   // starts rotating the servo
void hw_servoStop();                    // stops rotating the servo
